...
<style>
::-webkit-scrollbar {   width: 15px;} <!--스크롤바 넓이-->
...
::-webkit-scrollbar-button:start:decrement, ::-webkit-scrollbar-button:end:increment{   width: 16px;   height: 16px;   background: #f1f1f1;}
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <c:if test="${sessionScope.user.mid=='admin' }">
          	<a class="nav-link js-scroll-trigger" href="indexTib.do">tib</a>
            <a class="nav-link js-scroll-trigger" href="indexAdmin.do">tib(관리자 페이지)</a> <!-- 로그인 후 tib 페이지로 이동 -->
          </c:if>
          </li>
          </c:if>
        </ul>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-4 mx-auto">
               <h2>
                  공과 사를 분리해주는<BR> <strong>학생</strong>을위한 메신져
               </h2>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-12 mx-auto">
                <iframe src="index2.do" style="display:block; width:60vw; height: 80vh; border: none;" ></iframe>  
            </div>
         </div>
      </div>
   </section>
               ...
               <div class="FAQ">
                  <ul class="FAQlist">
                     <c:forEach var="dto" items="${lists }">
                        <li><input type="radio" name="list"
                           class="FAQlist-checkbox" id="list-input${dto.fidx }" checked />
                           <label for="list-input${dto.fidx }" class="FAQtitle">${dto.fsubject }</label>
                           <div class="FAQdesc">
                              <div>${dto.fcontent }</div>
                           </div></li>
                     </c:forEach>
                     <p></p>
                     <!-- 개행 -->
                     <h2>카카오톡으로 문의하기</h2>
                     <!-- ul추가안하고 li로만추가함 -->
                     <li><input type="radio" name="list" class="FAQlist-checkbox"
                        id="list-inputKAKAO" checked /> <label for="list-inputKAKAO"
                        class="FAQtitle"> <strong>Tib</strong>카카오톡 플러스로 1:1 문의하기
                     </label>
                        <div class="FAQdesc">
                           <div>
                              업무시간은 <strong>09:00~18:00시</strong> 까지이며 <br>점심시간<strong>12:00~13:00</strong>에는
                              업무 양이 많아 원할한 상담이 어려울수 있습니다. <br> <a
                                 href="http://pf.kakao.com/_CxoBgxb/chat"> <img
                                 src="img/FAQ/kakaotalk.png" alt="메인이미지" width="30"
                                 height="30"> 카카오톡으로 문의하기
                              </a>
                           </div>
                        </div></li>
                     <li><input type="radio" name="list" class="FAQlist-checkbox"
                        id="list-inputKAKAOQR" checked /> <label
                        for="list-inputKAKAOQR" class="FAQtitle"><strong>Tib</strong>고객센터
                           모바일 전용 QR코드</label>
                        <div class="FAQdesc">
                           <div>
                              <img src="img/FAQ/chatingQRcode.png" width="150" height="150">
                              <br>
                           </div>
                        </div></li>
                  </ul>
